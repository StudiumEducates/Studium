...
<head>
    ...
    <link rel="stylesheet" href="./src/public/css/works.css">
    <link rel="stylesheet" href="./src/public/css/root.css">
    <title>Studium - Trabalhos</title>
</head>
<body>
    <header id="header">
    ...
    <main id="app">
        <nav id="side_bar">
            ...
            <a href="trabalhos" class="Option" id="this">
                <img id="this_img" src="./src/public/midia/icon_menu/icon_white/works.png">
                ...
                <div class="blocks">
                    <?php
                        ...
                        if($cont == 0){
                            echo "<div class='no-activity'>";
                            echo "<div class='no-activity-background'>";
                            echo "<p class='no-activity-p'>Você não tem trabalhos para amanhã.<br>Volte mais tarde para ver se há algo novo.</p>";
                ...
                <div class="blocks">
                    <?php
                        ...
                        if($cont == 0){
                            echo "<div class='no-activity'>";
                            echo "<div class='no-activity-background'>";
                            echo "<p class='no-activity-p'>Você não tem outros trabalhos no momento.<br>Volte mais tarde para ver se há algo novo.</p>";
